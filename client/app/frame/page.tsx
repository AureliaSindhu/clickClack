...
import "../style.css";
import { colorFrames as dataColorFrames, customFrames as dataCustomFrames, Frame } from "./data/framesData";
...
export default function FramePage() {
    ...
    // Original dimensions and preview scaling factor
    ...
    // Use useMemo so that the frames don't reinitialize on every render.
    const colorFrames = useMemo(() => dataColorFrames, []);
    const customFrames = useMemo(() => dataCustomFrames, []);

    useEffect(() => {
        // Retrieve photos; if not found, redirect to the Capture page.
        ...
        // Retrieve selected frame; if missing, default to the first color frame.
        ...
        // Retrieve frame type from sessionStorage; default to color frames.
